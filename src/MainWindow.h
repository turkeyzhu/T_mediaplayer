...
protected:
    ...
    bool eventFilter(QObject *target, QEvent *event);  //turkeyzhu add for drag add outside items
    void dragEnterEvent(QDragEnterEvent *event) override;  //add drag
...
private:
    ...
    DragWidget *pdragWidget ;
    QString staticpath[2];


public slots:
    void add_File_Path(QString filePath);
